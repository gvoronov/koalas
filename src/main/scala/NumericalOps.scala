...
object NumericalOps {
   ...
   */
  implicit object NumericalValueOps extends Numeric[NumericalValue] {
  ...
  implicit object IntOps extends Numeric[Int] {
    // Members declared in scala.math.Numeric
  ...
  implicit object DoubleOps extends Numeric[Double] {
    // Members declared in scala.math.Numeric
